# CommandCoordinator — Dependency Graph
## Tissue ID: TIS-CMDCOORD-v0.1.0

### 1. Upstream Dependencies
| Dependency | Type | Required |
|-----------|------|----------|
| CEL-CMDPROCESS | Cell | Yes |
| CEL-CMDVALIDATE | Cell | Yes |
| CEL-CMDROUTER | Cell | Yes |
...
```typescript
class CommandCoordinatorBinder {
  ...
  validateBindings(): BindingValidationResult {
    const required = ["CEL-CMDPROCESS", "CEL-CMDVALIDATE", "CEL-CMDROUTER"];
