...
> **Package:** `@webwaka/tissue-cmd-coord`
...
The CommandCoordinator tissue coordinates 3 cells through an event-driven coordination engine with:
...
```typescript
import { CommandCoordinator } from '@webwaka/tissue-cmd-coord';

const tissue = new CommandCoordinator();
