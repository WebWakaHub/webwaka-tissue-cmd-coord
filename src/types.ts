/**
 * CommandCoordinator — Type Definitions
...
// Tissue Identity
export const TISSUE_ID = 'TIS-CMDCOORD-v0.1.0' as const;
export const TISSUE_HASH = '65e9e5db' as const;
export const CLASSIFICATION = 'Cross-Functional' as const;
export const COMPOSED_CELLS = ['CEL-CMDPROCESS', 'CEL-CMDVALIDATE', 'CEL-CMDROUTER'] as const;
